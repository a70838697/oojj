...
class Movenode extends CAction {
    public function run(){
        ...
        $parent = ($type=="inside") ? $refnode : $refnode->getParent();
        ...
        $differentparent = $parent->getAttribute($this->getController()->identity)!=$current->getParent()->getAttribute($this->getController()->identity);
