...
"#33FF33","#33CC00","#009900","#006600","#003300","#99FFFF","#33FFFF","#66CCCC","#00CCCC","#339999","#336666","#003333","#CCFFFF","#66FFFF","#33CCFF","#3366FF","#3333FF","#000099","#000066","#CCCCFF","#9999FF","#6666CC","#6633FF","#6600CC","#333399","#330099","#FFCCFF","#FF99FF","#CC66CC","#CC33CC","#993399","#663366","#330033"],sb=[{n:"p",t:"\u666e\u901a\u6bb5\u843d"},{n:"h1",t:"\u6a19\u984c1"},{n:"h2",t:"\u6a19\u984c2"},{n:"h3",t:"\u6a19\u984c3"},{n:"h4",t:"\u6a19\u984c4"},{n:"h5",t:"\u6a19\u984c5"},
{n:"h6",t:"\u6a19\u984c6"},{n:"pre",t:"\u5df2\u7de8\u6392\u683c\u5f0f"},{n:"address",t:"\u5730\u5740"}],tb=[{n:"\u65b0\u7d30\u660e\u9ad4",c:"PMingLiu"},{n:"\u7d30\u660e\u9ad4",c:"mingliu"},{n:"\u6a19\u6977\u9ad4",c:"DFKai-SB"},{n:"\u5fae\u8edf\u6b63\u9ed1\u9ad4",c:"Microsoft JhengHei"},{n:"Arial"},{n:"Arial Narrow"},{n:"Arial Black"},{n:"Comic Sans MS"},{n:"Courier New"},{n:"System"},{n:"Times New Roman"},{n:"Tahoma"},{n:"Verdana"}],S=[{n:"xx-small",wkn:"x-small",s:"8pt",t:"\u6975\u5c0f"},{n:"x-small",
wkn:"small",s:"10pt",t:"\u7279\u5c0f"},{n:"small",wkn:"medium",s:"12pt",t:"\u5c0f"},{n:"medium",wkn:"large",s:"14pt",t:"\u4e2d"},{n:"large",wkn:"x-large",s:"18pt",t:"\u5927"},{n:"x-large",wkn:"xx-large",s:"24pt",t:"\u7279\u5927"},{n:"xx-large",wkn:"-webkit-xxx-large",s:"36pt",t:"\u6975\u5927"}],ub=[{s:"\u9760\u5de6\u5c0d\u9f4a",v:"justifyleft"},{s:"\u7f6e\u4e2d",v:"justifycenter"},{s:"\u9760\u53f3\u5c0d\u9f4a",v:"justifyright"},{s:"\u5de6\u53f3\u5c0d\u9f4a",v:"justifyfull"}],vb=[{s:"\u6578\u5b57\u5217\u8868",
v:"insertOrderedList"},{s:"\u7b26\u865f\u5217\u8868",v:"insertUnorderedList"}],wb={"default":{name:"\u9810\u8a2d",width:24,height:24,line:7,list:{smile:"\u5fae\u7b11",tongue:"\u5410\u820c\u982d",titter:"\u5077\u7b11",laugh:"\u5927\u7b11",sad:"\u96e3\u904e",wronged:"\u59d4\u5c48",fastcry:"\u5feb\u54ed\u4e86",cry:"\u54ed",wail:"\u5927\u54ed",mad:"\u751f\u6c23",knock:"\u6572\u6253",curse:"\u7f75\u4eba",crazy:"\u6293\u72c2",angry:"\u767c\u706b",ohmy:"\u9a5a\u8a1d",awkward:"\u5c37\u5c2c",panic:"\u9a5a\u6050",
shy:"\u5bb3\u7f9e",cute:"\u53ef\u6190",envy:"\u7fa8\u6155",proud:"\u5f97\u610f",struggle:"\u596e\u9b25",quiet:"\u5b89\u975c",shutup:"\u9589\u5634",doubt:"\u7591\u554f",despise:"\u9119\u8996",sleep:"\u7761\u89ba",bye:"\u518d\u898b"}}},pa={Cut:{t:"\u526a\u4e0b (Ctrl+X)"},Copy:{t:"\u8907\u88fd (Ctrl+C)"},Paste:{t:"\u8cbc\u4e0a (Ctrl+V)"},Pastetext:{t:"\u8cbc\u4e0a\u6587\u672c",h:y?0:1},Blocktag:{t:"\u6bb5\u843d\u6a19\u7c64",h:1},Fontface:{t:"\u5b57\u578b",h:1},FontSize:{t:"\u5b57\u578b\u5927\u5c0f",
h:1},Bold:{t:"\u7c97\u9ad4 (Ctrl+B)",s:"Ctrl+B"},Italic:{t:"\u659c\u9ad4 (Ctrl+I)",s:"Ctrl+I"},Underline:{t:"\u5e95\u7dda (Ctrl+U)",s:"Ctrl+U"},Strikethrough:{t:"\u522a\u9664\u7dda"},FontColor:{t:"\u5b57\u578b\u984f\u8272",h:1},BackColor:{t:"\u80cc\u666f\u984f\u8272",h:1},SelectAll:{t:"\u5168\u9078 (Ctrl+A)"},Removeformat:{t:"\u522a\u9664\u6587\u5b57\u683c\u5f0f"},Align:{t:"\u5c0d\u9f4a",h:1},List:{t:"\u5217\u8868",h:1},Outdent:{t:"\u6e1b\u5c11\u7e2e\u6392 (Shift+Tab)",s:"Shift+Tab"},Indent:{t:"\u589e\u52a0\u7e2e\u6392 (Tab)",
s:"Tab"},Link:{t:"\u8d85\u9023\u7d50 (Ctrl+K)",s:"Ctrl+K",h:1},Unlink:{t:"\u53d6\u6d88\u8d85\u9023\u7d50"},Img:{t:"\u5716\u7247",h:1},Flash:{t:"Flash\u52d5\u756b",h:1},Media:{t:"\u591a\u5a92\u9ad4\u6587\u4ef6",h:1},Emot:{t:"\u8868\u60c5",s:"ctrl+e",h:1},Table:{t:"\u8868\u683c",h:1},Source:{t:"\u539f\u59cb\u78bc"},Preview:{t:"\u9810\u89bd"},Print:{t:"\u6253\u5370 (Ctrl+P)",s:"Ctrl+P"},Fullscreen:{t:"\u5168\u87a2\u5e55\u7de8\u8f2f (Esc)",s:"Esc"},About:{t:"\u95dc\u65bc xhEditor"}},Oa={mini:"Bold,Italic,Underline,Strikethrough,|,Align,List,|,Link,Img",
...
R:"&reg;",c:"&copy;"},zb=/[<>"Rc]/g;e.xheditor=function(z,C){function I(a){a=a.target;var b=xb[a.tagName.toLowerCase()];if(b){if(b==="Embed")b={"application/x-shockwave-flash":"Flash","application/x-mplayer2":"Media"}[a.type.toLowerCase()];d.exec(b)}}function $a(a){if(a.which===27){if(Ba)d.removeModal();else R&&d.hidePanel();return false}}function bb(){setTimeout(d.setSource,10)}function qa(){d.getSource()}function Ab(a){var b=o.cleanPaste;if(b===0||H||Pa)return true;Pa=true;d.saveBookmark();var c=
e('<div class="xhe-paste" style="top:'+$.scrollTop()+'px;" />',w),h=c[0],p=d.getSel(),m=d.getRng(true);e(w.body).append(c);if(y){m.moveToElementText(h);m.execCommand("Paste");a.preventDefault()}else{m.selectNodeContents(h);p.removeAllRanges();p.addRange(m)}setTimeout(function(){var l=b===3,i;if(l)i=c.text();else{i=e(".xhe-paste",c);var j=[];if(i.length===0)i=c;i.each(function(f,g){j.push(g.innerHTML)});i=j.join("<br />")}c.remove();d.loadBookmark();if(l)d.pasteText(i);else{i=d.cleanHTML(i);i=d.cleanWord(i);
i=d.formatXHTML(i);d.pasteHTML(i)}Pa=false},0)}function Qa(a){try{d._exec("styleWithCSS",a,true)}catch(b){try{d._exec("useCSS",!a,true)}catch(c){}}}function Ra(){if(Sa&&!H){Qa(false);try{d._exec("enableObjectResizing",true,true)}catch(a){}if(y)try{d._exec("BackgroundImageCache",true,true)}catch(b){}}}function Bb(a){if(H||a.which!==13||a.shiftKey||a.ctrlKey||a.altKey)return true;a=d.getParent("p,h1,h2,h3,h4,h5,h6,pre,address,div,li");if(a.is("li"))return true;if(o.forcePtag)a.length===0&&d._exec("formatblock",
"<p>");else{d.pasteHTML("<br />");y&&a.length>0&&d.getRng().parentElement().childNodes.length===2&&d.pasteHTML("<br />");return false}}function Ta(){if(!za&&!U){ra&&T.height("100%").css("height",T.outerHeight()-M.outerHeight());y&&M.hide().show()}}function Cb(a){a=a.target;if(a.tagName.match(/(img|embed)/i)){var b=d.getSel(),c=d.getRng(true);c.selectNode(a);b.removeAllRanges();b.addRange(c)}}function aa(a,b,c){if(!b)return false;var h="_xhe_"+b;if(c){if(Ca)c=ba(c,Ca,O);a.attr(b,O?ba(c,"abs",O):c).removeAttr(h).attr(h,
c)}return a.attr(h)||a.attr(b)}function Ua(){Aa&&d.hidePanel()}function Db(a){if(H)return true;var b=a.which,c=qb[b];b=c?c:String.fromCharCode(b).toLowerCase();sKey="";sKey+=a.ctrlKey?"ctrl+":"";sKey+=a.altKey?"alt+":"";sKey+=a.shiftKey?"shift+":"";sKey+=b;a=sa[sKey];for(var h in a){h=a[h];if(e.isFunction(h)){if(h.call(d)===false)return false}else{d.exec(h);return false}}}function ca(a,b){var c=typeof a;if(!b)return c!="undefined";if(b==="array"&&a.hasOwnProperty&&a instanceof Array)return true;return c===
...
(a=h+a);if(a.charAt(0)==="/"){m=[];a=a.split("/");var i=a.length;for(h=0;h<i;h++){l=a[h];if(l==="..")m.pop();else l!==""&&l!=="."&&m.push(l)}a[i-1]===""&&m.push("");a="/"+m.join("/")}}if(b==="abs"&&!a.match(/^https?:\/\//i))a=c+"//"+p+a;return a=a.replace(/(https?:\/\/[^:\/?#]+):80(\/|$)/i,"$1$2")}function cb(a,b){if(b==="*"||a.match(RegExp(".("+b.replace(/,/g,"|")+")$","i")))return true;else{alert("\u4e0a\u50b3\u6587\u4ef6\u64f4\u5c55\u540d\u5fc5\u9700\u70ba: "+b);return false}}function db(a){var b=
Math.floor(Math.log(a)/Math.log(1024));return(a/Math.pow(1024,Math.floor(b))).toFixed(2)+["Byte","KB","MB","GB","TB","PB"][b]}function W(){return false}var d=this,P=e(z),eb=P.closest("form"),M,T,X,$,w,Da,ja,Sa=false,H=false,ra=false,Pa=false,Va,ta=false,fb="",Q=null,Wa,ua=false,Xa=false,ka=null,da=null,Y=0,o=d.settings=e.extend({},{skin:"default",tools:"full",clickCancelDialog:true,linkTag:false,internalScript:false,inlineScript:false,internalStyle:true,inlineStyle:true,showBlocktag:false,forcePtag:true,
upLinkExt:"zip,rar,txt",upImgExt:"jpg,jpeg,gif,png",upFlashExt:"swf",upMediaExt:"wmv,avi,wma,mp3,mid",modalWidth:350,modalHeight:220,modalTitle:true,defLinkText:"\u9ede\u64ca\u6253\u958b\u93c8\u63a5",layerShadow:3,emotMark:false,upBtnText:"\u4e0a\u50b3",cleanPaste:2,hoverExecDelay:100,html5Upload:true,upMultiple:99},C),Ea=o.plugins,Fa=[];if(Ea){pa=e.extend({},pa,Ea);e.each(Ea,function(a){Fa.push(a)});Fa=Fa.join(",")}if(o.tools.match(/^\s*(m?full|simple|mini)\s*$/i)){var gb=Oa[e.trim(o.tools)];o.tools=
o.tools.match(/m?full/i)&&Ea?gb.replace("Table","Table,"+Fa):gb}o.tools.match(/(^|,)\s*About\s*(,|$)/i)||(o.tools+=",About");o.tools=o.tools.split(",");if(o.editorRoot)V=o.editorRoot;V=ba(V,"abs");if(o.urlBase)o.urlBase=ba(o.urlBase,"abs");var hb="xheCSS_"+o.skin,va="xhe"+ga+"_container",ib="xhe"+ga+"_Tool",jb="xhe"+ga+"_iframearea",kb="xhe"+ga+"_iframe",Ga="xhe"+ga+"_fixffcursor",wa="",la="",Ya=V+"xheditor_skin/"+o.skin+"/",Ha=wb,Ca=o.urlType,O=o.urlBase,ea=o.emotPath;ea=ea?ea:V+"xheditor_emot/";
var Za="";Ha=e.extend({},Ha,o.emots);ea=ba(ea,"rel",O?O:null);if(ta=o.showBlocktag)la+=" showBlocktag";var sa=[];this.init=function(){e("#"+hb).length===0&&e("head").append('<link id="'+hb+'" rel="stylesheet" type="text/css" href="'+Ya+'ui.css" />');var a=o.width||z.style.width||P.outerWidth();Y=o.height||z.style.height||P.outerHeight();if(ca(Y,"string"))Y=Y.replace(/[^\d]+/g,"");if(a<=0||Y<=0){alert("\u7576\u524dtextarea\u8655\u65bc\u96b1\u85cf\u72c0\u614b\uff0c\u8acb\u5c07\u4e4b\u986f\u793a\u5f8c\u518d\u521d\u59cb\u5316xhEditor\uff0c\u6216\u8005\u76f4\u63a5\u8a2d\u7f6etextarea\u7684width\u548cheight\u6a23\u5f0f");
...
e('<div style="font:12px Arial;width:245px;word-wrap:break-word;word-break:break-all;"><p><span style="font-size:20px;color:#1997DF;">xhEditor</span><br />v1.1.4 (build 110201)</p><p>xhEditor\u662f\u57fa\u65bcjQuery\u958b\u767c\u7684\u8de8\u5e73\u53f0\u8f15\u91cfXHTML\u7de8\u8f2f\u5668\uff0c\u57fa\u65bc<a href="http://www.gnu.org/licenses/lgpl.html" target="_blank">LGPL</a>\u958b\u6e90\u5354\u8b70\u767c\u4f48\u3002</p><p>Copyright c <a href="http://xheditor.com/" target="_blank">xhEditor.com</a>. All rights reserved.</p></div>');
...
o.upBtnText+'" class="xheBtn" tabindex="-1" /></span>'),m=e(".xheBtn",p),l=o.html5Upload,i=l?o.upMultiple:1;a.after(p);m.before(a);b=b.replace(/{editorRoot}/ig,V);if(b.substr(0,1)==="!")m.click(function(){R=false;d.showIframeModal("\u4e0a\u50b3\u6587\u4ef6",b.substr(1),h,null,null,function(){R=true})});else{p.append('<input type="file"'+(i>1?' multiple=""':"")+' class="xheFile" size="13" name="filedata" tabindex="-1" />');var j=e(".xheFile",p);j.change(function(){d.startUpload(j[0],b,c,h)});setTimeout(function(){a.closest(".xheDialog").bind("dragenter dragover",
W).bind("drop",function(f){f=f.originalEvent.dataTransfer;var g;if(l&&f&&(g=f.files)&&g.length>0)d.startUpload(g,b,c,h);return false})},10)}};this.startUpload=function(a,b,c,h){function p(r,v){var s=Object,t=false;try{s=eval("("+r+")")}catch(A){}if(s.err===undefined||s.msg===undefined)alert(b+" \u4e0a\u50b3\u63a5\u53e3\u767c\u751f\u932f\u8aa4\uff01\r\n\r\n\u8fd4\u56de\u7684\u932f\u8aa4\u5167\u5bb9\u70ba: \r\n\r\n"+r);else if(s.err)alert(s.err);else{m.push(s.msg);t=true}if(!t||v)d.removeModal();v&&
t&&h(m);return t}var m=[],l=o.html5Upload,i=l?o.upMultiple:1,j,f,g=e('<div style="padding:22px 0;text-align:center;line-height:30px;">\u6587\u4ef6\u4e0a\u50b3\u4e2d\uff0c\u8acb\u7a0d\u5019\u2026\u2026<br /></div>'),n='<img src="'+Ya+'img/loading.gif">';if(!l||a.nodeType&&!((f=a.files)&&f[0])){if(!cb(a.value,c))return;g.append(n);j=new d.html4Upload(a,b,p)}else{f||(f=a);a=f.length;if(a>i){alert("\u8acb\u4e0d\u8981\u4e00\u6b21\u4e0a\u50b3\u8d85\u904e"+i+"\u500b\u6587\u4ef6");return}for(i=0;i<a;i++)if(!cb(f[i].fileName,
c))return;var k=e('<div class="xheProgress"><div><span>0%</span></div></div>');g.append(k);j=new d.html5Upload("filedata",f,b,p,function(r){if(r.loaded>=0){var v=Math.round(r.loaded*100/r.total)+"%";e("div",k).css("width",v);e("span",k).text(v+" ( "+db(r.loaded)+" / "+db(r.total)+" )")}else k.replaceWith(n)})}var q=R;if(q)R=false;d.showModal("\u6587\u4ef6\u4e0a\u50b3\u4e2d(Esc\u53d6\u6d88\u4e0a\u50b3)",g,320,150,function(){R=q;j.remove()});j.start()};this.html4Upload=function(a,b,c){var h="jUploadFrame"+
...
'<div class="xheModalTitle"><span class="xheModalClose" title="\u95dc\u9589 (Esc)"></span>'+a+"</div>":"")+'<div class="xheModalContent"></div></div>').appendTo("body");La=e('<div class="xheModalOverlay"></div>').appendTo("body");if(ia>0)Ka=e('<div class="xheModalShadow" style="width:'+Z.outerWidth()+"px;height:"+Z.outerHeight()+"px;margin-left:-"+(Math.ceil(c/2)-ia-2)+"px;"+(y&&Ja<=7?"":"margin-top:-"+(Math.ceil(h/2)-ia-2)+"px")+'"></div>').appendTo("body");e(".xheModalContent",Z).css("height",h-
...
case "copy":try{w.execCommand(a);if(!w.queryCommandSupported(a))throw"Error";}catch(p){alert("\u60a8\u7684\u700f\u89bd\u5668\u5b89\u5168\u8a2d\u7f6e\u4e0d\u5141\u8a31\u4f7f\u7528\u8907\u88fd\u64cd\u4f5c\uff0c\u8acb\u4f7f\u7528\u9375\u76e4\u5feb\u6377\u9375(Ctrl + C)\u4f86\u5b8c\u6210")}break;case "paste":try{w.execCommand(a);if(!w.queryCommandSupported(a))throw"Error";}catch(m){alert("\u60a8\u7684\u700f\u89bd\u5668\u5b89\u5168\u8a2d\u7f6e\u4e0d\u5141\u8a31\u4f7f\u7528\u8cbc\u4e0a\u64cd\u4f5c\uff0c\u8acb\u4f7f\u7528\u9375\u76e4\u5feb\u6377\u9375(Ctrl + V)\u4f86\u5b8c\u6210")}break;
