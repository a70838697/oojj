...
if(b){if(b==="Embed")b={"application/x-shockwave-flash":"Flash","application/x-mplayer2":"Media"}[a.type.toLowerCase()];d.exec(b)}}function $a(a){if(a.which===27){if(Ba)d.removeModal();else R&&d.hidePanel();return false}}function bb(){setTimeout(d.setSource,10)}function qa(){d.getSource()}function Ab(a){var b=o.cleanPaste;if(b===0||H||Pa)return true;Pa=true;d.saveBookmark();var c=e('<div class="xhe-paste" style="top:'+$.scrollTop()+'px;" />',w),h=c[0],p=d.getSel(),m=d.getRng(true);e(w.body).append(c);
if(y){m.moveToElementText(h);m.execCommand("Paste");a.preventDefault()}else{m.selectNodeContents(h);p.removeAllRanges();p.addRange(m)}setTimeout(function(){var l=b===3,i;if(l)i=c.text();else{i=e(".xhe-paste",c);var j=[];if(i.length===0)i=c;i.each(function(f,g){j.push(g.innerHTML)});i=j.join("<br />")}c.remove();d.loadBookmark();if(l)d.pasteText(i);else{i=d.cleanHTML(i);i=d.cleanWord(i);i=d.formatXHTML(i);d.pasteHTML(i)}Pa=false},0)}function Qa(a){try{d._exec("styleWithCSS",a,true)}catch(b){try{d._exec("useCSS",
!a,true)}catch(c){}}}function Ra(){if(Sa&&!H){Qa(false);try{d._exec("enableObjectResizing",true,true)}catch(a){}if(y)try{d._exec("BackgroundImageCache",true,true)}catch(b){}}}function Bb(a){if(H||a.which!==13||a.shiftKey||a.ctrlKey||a.altKey)return true;a=d.getParent("p,h1,h2,h3,h4,h5,h6,pre,address,div,li");if(a.is("li"))return true;if(o.forcePtag)a.length===0&&d._exec("formatblock","<p>");else{d.pasteHTML("<br />");y&&a.length>0&&d.getRng().parentElement().childNodes.length===2&&d.pasteHTML("<br />");
return false}}function Ta(){if(!za&&!U){ra&&T.height("100%").css("height",T.outerHeight()-M.outerHeight());y&&M.hide().show()}}function Cb(a){a=a.target;if(a.tagName.match(/(img|embed)/i)){var b=d.getSel(),c=d.getRng(true);c.selectNode(a);b.removeAllRanges();b.addRange(c)}}function aa(a,b,c){if(!b)return false;var h="_xhe_"+b;if(c){if(Ca)c=ba(c,Ca,O);a.attr(b,O?ba(c,"abs",O):c).removeAttr(h).attr(h,c)}return a.attr(h)||a.attr(b)}function Ua(){Aa&&d.hidePanel()}function Db(a){if(H)return true;var b=
a.which,c=qb[b];b=c?c:String.fromCharCode(b).toLowerCase();sKey="";sKey+=a.ctrlKey?"ctrl+":"";sKey+=a.altKey?"alt+":"";sKey+=a.shiftKey?"shift+":"";sKey+=b;a=sa[sKey];for(var h in a){h=a[h];if(e.isFunction(h)){if(h.call(d)===false)return false}else{d.exec(h);return false}}}function ca(a,b){var c=typeof a;if(!b)return c!="undefined";if(b==="array"&&a.hasOwnProperty&&a instanceof Array)return true;return c===b}function ba(a,b,c){if(a.match(/^(file|mailto|ftp):/i))return a;var h=c?e('<a href="'+c+'" />')[0]:
location;c=h.protocol;var p=h.host,m=h.hostname,l=h.port;h=h.pathname.replace(/\\/g,"/").replace(/[^\/]+$/i,"");if(l==="")l="80";if(h==="")h="/";else if(h.charAt(0)!=="/")h="/"+h;a=e.trim(a);if(b!=="abs")a=a.replace(RegExp(c+"\\/\\/"+m.replace(/\./g,"\\.")+"(?::"+l+")"+(l==="80"?"?":"")+"(/|$)","i"),"/");if(b==="rel")a=a.replace(RegExp("^"+h.replace(/([\/\.\+\[\]\(\)])/g,"\\$1"),"i"),"");if(b!=="rel"){a.match(/^(https?:\/\/|\/)/i)||(a=h+a);if(a.charAt(0)==="/"){m=[];a=a.split("/");var i=a.length;
for(h=0;h<i;h++){l=a[h];if(l==="..")m.pop();else l!==""&&l!=="."&&m.push(l)}a[i-1]===""&&m.push("");a="/"+m.join("/")}}if(b==="abs"&&!a.match(/^https?:\/\//i))a=c+"//"+p+a;return a=a.replace(/(https?:\/\/[^:\/?#]+):80(\/|$)/i,"$1$2")}function cb(a,b){if(b==="*"||a.match(RegExp(".("+b.replace(/,/g,"|")+")$","i")))return true;else{alert("Upload file extension required for this: "+b);return false}}function db(a){var b=Math.floor(Math.log(a)/Math.log(1024));return(a/Math.pow(1024,Math.floor(b))).toFixed(2)+
["Byte","KB","MB","GB","TB","PB"][b]}function W(){return false}var d=this,P=e(z),eb=P.closest("form"),M,T,X,$,w,Da,ja,Sa=false,H=false,ra=false,Pa=false,Va,ta=false,fb="",Q=null,Wa,ua=false,Xa=false,ka=null,da=null,Y=0,o=d.settings=e.extend({},{skin:"default",tools:"full",clickCancelDialog:true,linkTag:false,internalScript:false,inlineScript:false,internalStyle:true,inlineStyle:true,showBlocktag:false,forcePtag:true,upLinkExt:"zip,rar,txt",upImgExt:"jpg,jpeg,gif,png",upFlashExt:"swf",upMediaExt:"wmv,avi,wma,mp3,mid",
modalWidth:350,modalHeight:220,modalTitle:true,defLinkText:"Click to open link",layerShadow:3,emotMark:false,upBtnText:"Upload",cleanPaste:2,hoverExecDelay:100,html5Upload:true,upMultiple:99},C),Ea=o.plugins,Fa=[];if(Ea){pa=e.extend({},pa,Ea);e.each(Ea,function(a){Fa.push(a)});Fa=Fa.join(",")}if(o.tools.match(/^\s*(m?full|simple|mini)\s*$/i)){var gb=Oa[e.trim(o.tools)];o.tools=o.tools.match(/m?full/i)&&Ea?gb.replace("Table","Table,"+Fa):gb}o.tools.match(/(^|,)\s*About\s*(,|$)/i)||(o.tools+=",About");
o.tools=o.tools.split(",");if(o.editorRoot)V=o.editorRoot;V=ba(V,"abs");if(o.urlBase)o.urlBase=ba(o.urlBase,"abs");var hb="xheCSS_"+o.skin,va="xhe"+ga+"_container",ib="xhe"+ga+"_Tool",jb="xhe"+ga+"_iframearea",kb="xhe"+ga+"_iframe",Ga="xhe"+ga+"_fixffcursor",wa="",la="",Ya=V+"xheditor_skin/"+o.skin+"/",Ha=wb,Ca=o.urlType,O=o.urlBase,ea=o.emotPath;ea=ea?ea:V+"xheditor_emot/";var Za="";Ha=e.extend({},Ha,o.emots);ea=ba(ea,"rel",O?O:null);if(ta=o.showBlocktag)la+=" showBlocktag";var sa=[];this.init=function(){e("#"+
hb).length===0&&e("head").append('<link id="'+hb+'" rel="stylesheet" type="text/css" href="'+Ya+'ui.css" />');var a=o.width||z.style.width||P.outerWidth();Y=o.height||z.style.height||P.outerHeight();if(ca(Y,"string"))Y=Y.replace(/[^\d]+/g,"");if(a<=0||Y<=0){alert("Current textarea is hidden, please make it show before initialization xhEditor, or directly initialize the height.");return false}if(/^[0-9\.]+$/i.test(""+a))a+="px";var b=o.background||z.style.background,c=['<span class="xheGStart"/>'],
h,p,m=/\||\//i;e.each(o.tools,function(f,g){g.match(m)&&c.push('<span class="xheGEnd"/>');if(g==="|")c.push('<span class="xheSeparator"/>');else if(g==="/")c.push("<br />");else{h=pa[g];if(!h)return;p=h.c?h.c:"xheIcon xheBtn"+g;c.push('<span><a href="javascript:void(0);" title="'+h.t+'" name="'+g+'" class="xheButton xheEnabled" tabindex="-1"><span class="'+p+'" unselectable="on" /></a></span>');h.s&&d.addShortcuts(h.s,g)}g.match(m)&&c.push('<span class="xheGStart"/>')});c.push('<span class="xheGEnd"/><br />');
P.after(e('<input type="text" id="'+Ga+'" style="position:absolute;display:none;" /><span id="'+va+'" class="xhe_'+o.skin+'" style="display:none"><table cellspacing="0" cellpadding="0" class="xheLayout" style="width:'+a+";height:"+Y+'px;"><tbody><tr><td id="'+ib+'" class="xheTool" unselectable="on" style="height:1px;"></td></tr><tr><td id="'+jb+'" class="xheIframeArea"><iframe frameborder="0" id="'+kb+'" src="javascript:;" style="width:100%;"></iframe></td></tr></tbody></table></span>'));M=e("#"+
ib);T=e("#"+jb);wa='<meta content="text/html; charset=UTF-8" http-equiv="Content-Type"/><link rel="stylesheet" href="'+Ya+'iframe.css"/>';if(a=o.loadCSS)if(ca(a,"array"))for(var l in a)wa+='<link rel="stylesheet" href="'+a[l]+'"/>';else wa+=a.match(/\s*<style(\s+[^>]*?)?>[\s\S]+?<\/style>\s*/i)?a:'<link rel="stylesheet" href="'+a+'"/>';l="<html><head>"+wa;if(b)l+="<style>body{background:"+b+";}</style>";l+='</head><body spellcheck="false" class="editMode'+la+'"></body></html>';d.win=X=e("#"+kb)[0].contentWindow;
$=e(X);try{this.doc=w=X.document;Da=e(w);w.open();w.write(l);w.close();if(y)w.body.contentEditable="true";else w.designMode="On"}catch(i){}setTimeout(Ra,300);d.setSource();X.setInterval=null;M.append(c.join("")).bind("mousedown contextmenu",W).click(function(f){var g=e(f.target).closest("a");if(g.is(".xheEnabled")){Q=f;d.exec(g.attr("name"))}return false});M.find(".xheButton").hover(function(f){var g=e(this),n=o.hoverExecDelay,k=da;da=null;if(n===-1||ua||!g.is(".xheEnabled"))return false;if(k&&k>
10){ua=true;setTimeout(function(){ua=false},100);return false}var q=g.attr("name");if(pa[q].h!==1){d.hidePanel();return false}if(Xa)n=0;if(n>=0)Wa=setTimeout(function(){Q=f;ka={x:Q.clientX,y:Q.clientY};d.exec(q)},n)},function(){ka=null;Wa&&clearTimeout(Wa)}).mousemove(function(f){if(ka){var g={x:f.clientX-ka.x,y:f.clientY-ka.y};if(Math.abs(g.x)>1||Math.abs(g.y)>1){if(g.x>0&&g.y>0){g=Math.round(Math.atan(g.y/g.x)/0.017453293);da=da?(da+g)/2:g}else da=null;ka={x:f.clientX,y:f.clientY}}}});N=e("#xhePanel");
na=e("#xheShadow");oa=e("#xheCntLine");if(N.length===0){N=e('<div id="xhePanel"></div>').mousedown(function(f){f.stopPropagation()});na=e('<div id="xheShadow"></div>');oa=e('<div id="xheCntLine"></div>');setTimeout(function(){e(document.body).append(N).append(na).append(oa)},10)}e("#"+va).show();P.hide();T.css("height",Y-M.outerHeight());P.focus(d.focus);eb.submit(qa).bind("reset",bb);e(window).bind("unload beforeunload",qa).bind("resize",Ta);e(document).mousedown(Ua);if(!ab){e(document).keydown($a);
ab=true}$.focus(function(){o.focus&&o.focus()}).blur(function(){o.blur&&o.blur()});U&&$.click(Cb);Da.mousedown(Ua).keydown(Db).keypress(Bb).dblclick(I).bind("mousedown click",function(f){P.trigger(f.type)});if(y){Da.keydown(function(f){var g=d.getRng();if(f.which===8&&g.item){e(g.item(0)).remove();return false}});var j=function(f){f=e(f.target);var g;if(g=f.css("width"))f.css("width","").attr("width",g.replace(/[^0-9%]+/g,""));if(g=f.css("height"))f.css("height","").attr("height",g.replace(/[^0-9%]+/g,
""))};Da.bind("controlselect",function(f){f=f.target;e.nodeName(f,"IMG")&&e(f).unbind("resizeend",j).bind("resizeend",j)})}b=e(w.documentElement);b.bind("paste",Ab);o.disableContextmenu&&b.bind("contextmenu",W);o.html5Upload&&b.bind("dragenter dragover",function(f){var g;if((g=f.originalEvent.dataTransfer.types)&&e.inArray("Files",g)!==-1)return false}).bind("drop",function(f){f=f.originalEvent.dataTransfer;var g;if(f&&(g=f.files)&&g.length>0){var n,k;f=["Link","Img","Flash","Media"];var q=[],r;for(n in f){k=
f[n];o["up"+k+"Url"]&&o["up"+k+"Url"].match(/^[^!].*/i)&&q.push(k+":,"+o["up"+k+"Ext"])}if(q.length===0)return false;else r=q.join(",");k=function(v){var s,t;for(n=0;n<v.length;n++){s=v[n].fileName.replace(/.+\./,"");if(s=r.match(RegExp("(\\w+):[^:]*,"+s+"(?:,|$)","i")))if(t){if(t!==s[1])return 2}else t=s[1];else return 1}return t}(g);if(k===1)alert("Upload file extension required for this: "+r.replace(/\w+:,/g,""));else if(k===2)alert("You can only drag and drop the same type of file.");else k&&
d.startUpload(g,o["up"+k+"Url"],"*",function(v){var s=[],t;(t=o.onUpload)&&t(v);for(n in v){t=v[n];url=ca(t,"string")?t:t.url;if(url.substr(0,1)==="!")url=url.substr(1);s.push(url)}d.exec(k);e("#xhe"+k+"Url").val(s.join(" "));e("#xheSave").click()});return false}});(b=o.shortcuts)&&e.each(b,function(f,g){d.addShortcuts(f,g)});ga++;Sa=true;if(o.fullscreen)d.toggleFullscreen();else o.sourceMode&&setTimeout(d.toggleSource,20);return true};this.remove=function(){d.hidePanel();qa();P.unbind("focus",d.focus);
eb.unbind("submit",qa).unbind("reset",bb);e(window).unbind("unload beforeunload",qa).unbind("resize",Ta);e(document).unbind("mousedown",Ua);e("#"+va).remove();e("#"+Ga).remove();P.show();Sa=false};this.saveBookmark=function(){if(!H){var a=d.getRng();a=a.cloneRange?a.cloneRange():a;ja={top:$.scrollTop(),rng:a}}};this.loadBookmark=function(){if(!(H||!ja)){d.focus();var a=ja.rng;if(y)a.select();else{var b=d.getSel();b.removeAllRanges();b.addRange(a)}$.scrollTop(ja.top);ja=null}};this.focus=function(){H?
e("#sourceCode",w).focus():$.focus();if(y){var a=d.getRng();a.parentElement&&a.parentElement().ownerDocument!==w&&d.setCursorFirst()}return false};this.setCursorFirst=function(a){X.scrollTo(0,0);var b=d.getRng(true),c=w.body,h=c,p;if(a&&h.firstChild&&(p=h.firstChild.tagName)&&p.match(/^p|div|h[1-6]$/i))h=c.firstChild;y?b.moveToElementText(h):b.setStart(h,0);b.collapse(true);if(y)b.select();else{a=d.getSel();a.removeAllRanges();a.addRange(b)}};this.getSel=function(){return X.getSelection?X.getSelection():
w.selection};this.getRng=function(a){var b,c;try{if(!a){b=d.getSel();c=b.rangeCount>0?b.getRangeAt(0):b.createRange?b.createRange():null}c||(c=w.createRange?w.createRange():w.body.createTextRange())}catch(h){}return c};this.getParent=function(a){var b=d.getRng(),c;if(y)c=b.item?b.item(0):b.parentElement();else{c=b.commonAncestorContainer;if(!b.collapsed)if(b.startContainer===b.endContainer&&b.startOffset-b.endOffset<2&&b.startContainer.hasChildNodes())c=b.startContainer.childNodes[b.startOffset]}a=
...
b){if(H)return false;d.focus();a=d.processHTML(a,"write");var c=d.getSel(),h=d.getRng();if(b!==undefined){if(h.item){var p=h.item(0);h=d.getRng(true);h.moveToElementText(p);h.select()}h.collapse(b)}a+="<"+(y?"img":"span")+' id="_xhe_temp" width="0" height="0" />';if(h.insertNode){h.deleteContents();h.insertNode(h.createContextualFragment(a))}else{if(c.type.toLowerCase()==="control"){c.clear();h=d.getRng()}h.pasteHTML(a)}p=e("#_xhe_temp",w);var m=p[0];if(y){h.moveToElementText(m);h.select()}else{h.selectNode(m);
c.removeAllRanges();c.addRange(h)}p.remove()};this.pasteText=function(a,b){a||(a="");a=d.domEncode(a);a=a.replace(/\r?\n/g,"<br />");d.pasteHTML(a,b)};this.appendHTML=function(a){if(H)return false;d.focus();a=d.processHTML(a,"write");e(w.body).append(a)};this.domEncode=function(a){return a.replace(zb,function(b){return yb[b]})};this.setSource=function(a){ja=null;if(typeof a!=="string"&&a!=="")a=z.value;if(H)e("#sourceCode",w).val(a);else{if(o.beforeSetSource)a=o.beforeSetSource(a);a=d.cleanHTML(a);
a=d.formatXHTML(a);a=d.processHTML(a,"write");if(y){w.body.innerHTML='<img id="_xhe_temp" width="0" height="0" />'+a+"\n";e("#_xhe_temp",w).remove()}else w.body.innerHTML=a}};this.processHTML=function(a,b){if(b==="write"){a=a.replace(/(<(\/?)(\w+))((?:\s+[\w-]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*((\/?)>)/g,function(m,l,i,j,f,g,n){j=j.toLowerCase();if(za)if(j==="strong")j="b";else{if(j==="em")j="i"}else if(U)if(j==="strong"){j="span";i||(f+=' class="Apple-style-span" style="font-weight: bold;"')}else if(j===
"em"){j="span";i||(f+=' class="Apple-style-span" style="font-style: italic;"')}else if(j==="u"){j="span";i||(f+=' class="Apple-style-span" style="text-decoration: underline;"')}else if(j==="strike"){j="span";i||(f+=' class="Apple-style-span" style="text-decoration: line-through;"')}var k,q;if(j==="del")j="strike";else if(j==="img")f=f.replace(/\s+emot\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i,function(v,s){k=s.match(/^(["']?)(.*)\1/)[2];k=k.split(",");if(!k[1]){k[1]=k[0];k[0]=""}if(k[0]==="default")k[0]=
"";return o.emotMark?v:""});else if(j==="a"&&n)g="></a>";else if(j==="table"&&!i){m=f.match(/\s+border\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i);if(!m||m[1].match(/^(["']?)\s*0\s*\1$/))q="xhe-border"}var r;f=f.replace(/\s+([\w-]+)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/g,function(v,s,t){s=s.toLowerCase();t=t.match(/^(["']?)(.*)\1/)[2];aft="";if(y&&s.match(/^(disabled|checked|readonly|selected)$/)&&t.match(/^(false|0)$/i))return"";if(j==="img"&&k&&s==="src")return"";if(s.match(/^(src|href)$/)){aft=" _xhe_"+s+'="'+
t+'"';if(O)t=ba(t,"abs",O)}if(q&&s==="class"){t+=" "+q;q=""}if(U&&s==="style"){t=t.replace(/(^|;)\s*(font-size)\s*:\s*([a-z-]+)\s*(;|$)/i,function(A,K,D,F,B){for(var E,L=0;L<S.length;L++){A=S[L];if(F===A.n){E=A.wkn;break}}return K+D+":"+E+B});if(j==="span"&&t.match(/(^|;)\s*(font-family|font-size|color|background-color)\s*:\s*[^;]+\s*(;|$)/i))r=true}return" "+s+'="'+t+'"'+aft});if(k)f+=' src="'+ea+(k[0]?k[0]:"default")+"/"+k[1]+'.gif"';if(r)f+=' class="Apple-style-span"';if(q)f+=' class="'+q+'"';
return"<"+i+j+f+g});if(y)a=a.replace(/&apos;/ig,"&#39;");if(!U){var c=function(m,l,i,j){l="";var f,g;if(f=i.match(/font-family\s*:\s*([^;"]+)/i))l+=' face="'+f[1]+'"';if(f=i.match(/font-size\s*:\s*([^;"]+)/i)){f=f[1].toLowerCase();for(var n=0;n<S.length;n++)if(f===S[n].n||f===S[n].s){g=n+1;break}if(g){l+=' size="'+g+'"';i=i.replace(/(^|;)(\s*font-size\s*:\s*[^;"]+;?)+/ig,"$1")}}if(g=i.match(/(?:^|[\s;])color\s*:\s*([^;"]+)/i)){if(f=g[1].match(/\s*rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/i)){g[1]=
"#";for(n=1;n<=3;n++)g[1]+=(f[n]-0).toString(16)}g[1]=g[1].replace(/^#([0-9a-f])([0-9a-f])([0-9a-f])$/i,"#$1$1$2$2$3$3");l+=' color="'+g[1]+'"'}i=i.replace(/(^|;)(\s*(font-family|color)\s*:\s*[^;"]+;?)+/ig,"$1");if(l!==""){if(i)l+=' style="'+i+'"';return"<font"+l+">"+j+"</font>"}else return m};a=a.replace(/<(span)(?:\s+[^>]*?)?\s+style\s*=\s*"((?:[^"]*?;)*\s*(?:font-family|font-size|color)\s*:[^"]*)"(?: [^>]*)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?<\/\1>)*?)<\/\1>/ig,
...
e('<div style="font:12px Arial;width:245px;word-wrap:break-word;word-break:break-all;"><p><span style="font-size:20px;color:#1997DF;">xhEditor</span><br />v1.1.4 (build 110201)</p><p>xhEditor is a platform independent WYSWYG XHTML editor based by jQuery,released as Open Source under <a href="http://www.gnu.org/licenses/lgpl.html" target="_blank">LGPL</a>.</p><p>Copyright \u00a9 <a href="http://xheditor.com/" target="_blank">xhEditor.com</a>. All rights reserved.</p></div>');d.showDialog(a)};this.addShortcuts=
...
o.upBtnText+'" class="xheBtn" tabindex="-1" /></span>'),m=e(".xheBtn",p),l=o.html5Upload,i=l?o.upMultiple:1;a.after(p);m.before(a);b=b.replace(/{editorRoot}/ig,V);if(b.substr(0,1)==="!")m.click(function(){R=false;d.showIframeModal("Upload file",b.substr(1),h,null,null,function(){R=true})});else{p.append('<input type="file"'+(i>1?' multiple=""':"")+' class="xheFile" size="13" name="filedata" tabindex="-1" />');var j=e(".xheFile",p);j.change(function(){d.startUpload(j[0],b,c,h)});setTimeout(function(){a.closest(".xheDialog").bind("dragenter dragover",
W).bind("drop",function(f){f=f.originalEvent.dataTransfer;var g;if(l&&f&&(g=f.files)&&g.length>0)d.startUpload(g,b,c,h);return false})},10)}};this.startUpload=function(a,b,c,h){function p(r,v){var s=Object,t=false;try{s=eval("("+r+")")}catch(A){}if(s.err===undefined||s.msg===undefined)alert(b+" upload interface error!\r\n\r\nreturn error:\r\n\r\n"+r);else if(s.err)alert(s.err);else{m.push(s.msg);t=true}if(!t||v)d.removeModal();v&&t&&h(m);return t}var m=[],l=o.html5Upload,i=l?o.upMultiple:1,j,f,g=
e('<div style="padding:22px 0;text-align:center;line-height:30px;">File uploading,please wait...<br /></div>'),n='<img src="'+Ya+'img/loading.gif">';if(!l||a.nodeType&&!((f=a.files)&&f[0])){if(!cb(a.value,c))return;g.append(n);j=new d.html4Upload(a,b,p)}else{f||(f=a);a=f.length;if(a>i){alert("Please do not upload more then "+i+" files.");return}for(i=0;i<a;i++)if(!cb(f[i].fileName,c))return;var k=e('<div class="xheProgress"><div><span>0%</span></div></div>');g.append(k);j=new d.html5Upload("filedata",
f,b,p,function(r){if(r.loaded>=0){var v=Math.round(r.loaded*100/r.total)+"%";e("div",k).css("width",v);e("span",k).text(v+" ( "+db(r.loaded)+" / "+db(r.total)+" )")}else k.replaceWith(n)})}var q=R;if(q)R=false;d.showModal("File uploading(Esc cancel)",g,320,150,function(){R=q;j.remove()});j.start()};this.html4Upload=function(a,b,c){var h="jUploadFrame"+(new Date).getTime(),p=this,m=e('<iframe name="'+h+'" class="xheHideArea" />').appendTo("body"),l=e('<form action="'+b+'" target="'+h+'" method="post" enctype="multipart/form-data" class="xheHideArea"></form>').appendTo("body"),
i=e(a),j=i.clone().attr("disabled","true");i.before(j).appendTo(l);this.remove=function(){if(p!==null){j.before(i).remove();m.remove();l.remove();p=null}};this.onLoad=function(){c(e(m[0].contentWindow.document.body).text(),true)};this.start=function(){l.submit();m.load(p.onLoad)};return this};this.html5Upload=function(a,b,c,h,p){function m(r,v,s,t){i=new XMLHttpRequest;upload=i.upload;i.onreadystatechange=function(){i.readyState===4&&s(i.responseText)};if(upload)upload.onprogress=function(A){t(A.loaded)};
else t(-1);i.open("POST",v);i.setRequestHeader("Content-Type","application/octet-stream");i.setRequestHeader("Content-Disposition",'attachment; name="'+a+'"; filename="'+r.fileName+'"');i.sendAsBinary?i.sendAsBinary(r.getAsBinary()):i.send(r)}function l(r){p&&p({loaded:g+r,total:n})}for(var i,j=0,f=b.length,g=0,n=0,k=this,q=0;q<f;q++)n+=b[q].fileSize;this.remove=function(){if(i){i.abort();i=null}};this.uploadNext=function(r){if(r){g+=b[j-1].fileSize;l(0)}if((!r||r&&h(r,j===f)===true)&&j<f)m(b[j++],
c,k.uploadNext,function(v){l(v)})};this.start=function(){k.uploadNext()}};this.showIframeModal=function(a,b,c,h,p,m){b=e('<iframe frameborder="0" src="'+b.replace(/{editorRoot}/ig,V)+'" style="width:100%;height:100%;display:none;" /><div class="xheModalIfmWait"></div>');var l=e(b[0]),i=e(b[1]);d.showModal(a,b,h,p,m);l.load(function(){var j=l[0].contentWindow,f=e(j.document);j.callback=function(g){d.removeModal();c(g)};j.unloadme=d.removeModal;f.keydown(d.checkEsc);l.show();i.remove()})};this.showModal=
function(a,b,c,h,p){if(Ba)return false;ia=o.layerShadow;c=c?c:o.modalWidth;h=h?h:o.modalHeight;Z=e('<div class="xheModal" style="width:'+(c-1)+"px;height:"+h+"px;margin-left:-"+Math.ceil(c/2)+"px;"+(y&&Ja<=7?"":"margin-top:-"+Math.ceil(h/2)+"px")+'">'+(o.modalTitle?'<div class="xheModalTitle"><span class="xheModalClose" title="Close (Esc)"></span>'+a+"</div>":"")+'<div class="xheModalContent"></div></div>').appendTo("body");La=e('<div class="xheModalOverlay"></div>').appendTo("body");if(ia>0)Ka=e('<div class="xheModalShadow" style="width:'+
Z.outerWidth()+"px;height:"+Z.outerHeight()+"px;margin-left:-"+(Math.ceil(c/2)-ia-2)+"px;"+(y&&Ja<=7?"":"margin-top:-"+(Math.ceil(h/2)-ia-2)+"px")+'"></div>').appendTo("body");e(".xheModalContent",Z).css("height",h-(o.modalTitle?e(".xheModalTitle").outerHeight():0)).html(b);if(y&&Ja===6)Ma=e("select:visible").css("visibility","hidden");e(".xheModalClose",Z).click(d.removeModal);La.show();ia>0&&Ka.show();Z.show();Ba=true;Na=p};this.removeModal=function(){Ma&&Ma.css("visibility","visible");Z.html("").remove();
ia>0&&Ka.remove();La.remove();Na&&Na();Ba=false};this.showDialog=function(a){var b=e('<div class="xheDialog"></div>');a=e(a);var c=e("#xheSave",a);if(c.length===1){a.find("input[type=text],select").keypress(function(m){if(m.which===13){c.click();return false}});a.find("textarea").keydown(function(m){if(m.ctrlKey&&m.which===13){c.click();return false}});c.after(' <input type="button" id="xheCancel" value="Cancel" />');e("#xheCancel",a).click(d.hidePanel);if(!o.clickCancelDialog){Aa=false;var h=e('<div class="xheFixCancel"></div>').appendTo("body").mousedown(W),
p=T.offset();h.css({left:p.left,top:p.top,width:T.outerWidth(),height:T.outerHeight()})}b.mousedown(function(){ua=true})}b.append(a);d.showPanel(b);y||setTimeout(function(){b.find("input[type=text],textarea").filter(":visible").filter(function(){return e(this).css("visibility")!=="hidden"}).eq(0).focus()},10)};this.showPanel=function(a){if(!Q.target)return false;N.html("").append(a).css("left",-999).css("top",-999);ha=e(Q.target).closest("a").addClass("xheActive");var b=ha.offset();a=b.left;b=b.top;
b+=ha.outerHeight()-1;oa.css({left:a+1,top:b,width:ha.width()}).show();if(a+N.outerWidth()>document.body.clientWidth)a-=N.outerWidth()-ha.outerWidth();var c=o.layerShadow;c>0&&na.css({left:a+c,top:b+c,width:N.outerWidth(),height:N.outerHeight()}).show();N.css({left:a,top:b}).show();Xa=R=true};this.hidePanel=function(){if(R){ha.removeClass("xheActive");na.hide();oa.hide();N.hide();R=false;if(!Aa){e(".xheFixCancel").remove();Aa=true}Xa=ua=false;da=null}};this.exec=function(a){d.focus();d.hidePanel();
...
case "paste":try{w.execCommand(a);if(!w.queryCommandSupported(a))throw"Error";}catch(m){alert("Currently not supported by your browser, use keyboard shortcuts(Ctrl+V) instead.")}break;case "pastetext":window.clipboardData?d.pasteText(window.clipboardData.getData("Text",true)):d.showPastetext();break;case "blocktag":var l=[];e.each(sb,function(f,g){l.push({s:"<"+g.n+">"+g.t+"</"+g.n+">",v:"<"+g.n+">",t:g.t})});d.showMenu(l,function(f){d._exec("formatblock",f)});break;case "fontface":var i=[];e.each(tb,
function(f,g){g.c=g.c?g.c:g.n;i.push({s:'<span style="font-family:'+g.c+'">'+g.n+"</span>",v:g.c,t:g.n})});d.showMenu(i,function(f){d._exec("fontname",f)});break;case "fontsize":var j=[];e.each(S,function(f,g){j.push({s:'<span style="font-size:'+g.s+';">'+g.t+"("+g.s+")</span>",v:f+1,t:g.t})});d.showMenu(j,function(f){d._exec("fontsize",f)});break;case "fontcolor":d.showColor(function(f){d._exec("forecolor",f)});break;case "backcolor":d.showColor(function(f){if(y)d._exec("backcolor",f);else{Qa(true);
