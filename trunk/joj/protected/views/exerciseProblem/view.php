...
if(strlen($problem->input_sample)>0) $tabs[$attrs['input_sample']]='<pre style="border: 1px solid blue">'.($problem->input_sample).'</pre>';
if(strlen($problem->output_sample)>0) $tabs[$attrs['output_sample']]='<pre style="border: 1px solid blue">'.($problem->output_sample).'</pre>';
