...
if(strlen($problem->input_sample)>0) $tabs[$attrs['input_sample']]='<pre>'.($problem->input_sample).'</pre>';
if(strlen($problem->output_sample)>0) $tabs[$attrs['output_sample']]='<pre>'.($problem->output_sample).'</pre>';
